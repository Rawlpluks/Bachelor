...
>In the meantime:
>Java is very close to C#, but our software team codes in C# so if u get the chance lean this way
>Quants play with python and C++, esp python for analysis/backtesting
>You can never do enough Kaggle competitions :)
>Good luck.
